...
UPDATE supla_client SET push_token = 'Token 2', platform = 1, devel_env = 0, app_id = 200, protocol_version = 20 WHERE id = 24;
...
UPDATE supla_client SET push_token = 'Token 5', platform = 1, devel_env = 1, profile_name = 'My Profile XYZ'  WHERE id = 33;
