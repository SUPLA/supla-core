...
void channelio_set_mcp23008_gpio_dir_1(unsigned char number, unsigned char value);
void channelio_set_mcp23008_gpio_val_1(unsigned char number, unsigned char value);
