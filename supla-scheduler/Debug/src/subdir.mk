...
src/%.o: ../src/%.cpp src/subdir.mk
	...
	g++ -D__DEBUG=1 -I$(INCMYSQL) -O3 -g3 -Wall -fsigned-char -c -fmessage-length=0 -fstack-protector-all -D_FORTIFY_SOURCE=2 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
src/%.o: ../src/%.c src/subdir.mk
	...
	gcc -D__DEBUG=1 -I$(INCMYSQL) -O3 -g3 -Wall -fsigned-char -c -fmessage-length=0 -fstack-protector-all -D_FORTIFY_SOURCE=2 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
