...
src/%.o: ../src/%.cpp src/subdir.mk
	...
	g++ -I$(INCMYSQL) -I../src -I/usr/include/cjson -O2 -Wall -fsigned-char -c -fmessage-length=0 -fstack-protector-all -fPIE -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
src/%.o: ../src/%.c src/subdir.mk
	...
	gcc -I$(INCMYSQL) -I../src -I/usr/include/cjson -O2 -Wall -fsigned-char -c -fmessage-length=0 -fstack-protector-all -fPIE -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
