...
src/supla-client-lib/%.o: ../src/supla-client-lib/%.c src/supla-client-lib/subdir.mk
	...
	gcc -D__DEBUG=1 -D__TEST=1 -DNOMYSQL=1 -D__OPENSSL_TOOLS=1 -D__SSOCKET_WRITE_TO_FILE=$(SSOCKET_WRITE_TO_FILE) -I../src/supla-client-lib -I../src -I../src/test -I$(SSLDIR)/include -O0 -g3 -Wall -fsigned-char  -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
src/supla-client-lib/%.o: ../src/supla-client-lib/%.cpp src/supla-client-lib/subdir.mk
	...
	g++ -D__DEBUG=1 -D__TEST=1 -DNOMYSQL=1 -D__OPENSSL_TOOLS=1 -D__SSOCKET_WRITE_TO_FILE=$(SSOCKET_WRITE_TO_FILE) -I$(SSLDIR)/include -I../src -I../src/supla-client-lib -I../src/test -O0 -g3 -Wall -fsigned-char  -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
