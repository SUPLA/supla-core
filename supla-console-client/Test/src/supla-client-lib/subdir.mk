...
src/supla-client-lib/%.o: ../src/supla-client-lib/%.c src/supla-client-lib/subdir.mk
	...
	gcc -D__DEBUG=1 -DUSE_DEPRECATED_EMEV_V1=1 -D__OPENSSL_TOOLS=1 -D__SSOCKET_WRITE_TO_FILE=$(SSOCKET_WRITE_TO_FILE) -I../src/supla-client-lib -I../src/test -I$(SSLDIR)/include -O0 -g3 -Wall -fsigned-char  -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
clean-src-2f-supla-2d-client-2d-lib:
	-$(RM) ./src/supla-client-lib/cfg.d ./src/supla-client-lib/cfg.o ./src/supla-client-lib/eh.d ./src/supla-client-lib/eh.o ./src/supla-client-lib/ini.d ./src/supla-client-lib/ini.o ./src/supla-client-lib/lck.d ./src/supla-client-lib/lck.o ./src/supla-client-lib/log.d ./src/supla-client-lib/log.o ./src/supla-client-lib/proto.d ./src/supla-client-lib/proto.o ./src/supla-client-lib/safearray.d ./src/supla-client-lib/safearray.o ./src/supla-client-lib/srpc.d ./src/supla-client-lib/srpc.o ./src/supla-client-lib/sthread.d ./src/supla-client-lib/sthread.o ./src/supla-client-lib/supla-client.d ./src/supla-client-lib/supla-client.o ./src/supla-client-lib/supla-socket.d ./src/supla-client-lib/supla-socket.o ./src/supla-client-lib/tools.d ./src/supla-client-lib/tools.o
