...
clean-src-2f-push:
	-$(RM) ./src/push/abstract_pn_gateway_client.d ./src/push/abstract_pn_gateway_client.o ./src/push/apns_client.d ./src/push/apns_client.o ./src/push/fcm_client.d ./src/push/fcm_client.o ./src/push/pn_dao.d ./src/push/pn_dao.o ./src/push/pn_delivery_task.d ./src/push/pn_delivery_task.o ./src/push/pn_delivery_task_thread_pool.d ./src/push/pn_delivery_task_thread_pool.o ./src/push/pn_dispatcher.d ./src/push/pn_dispatcher.o ./src/push/pn_gateway_access_token.d ./src/push/pn_gateway_access_token.o ./src/push/pn_gateway_access_token_provider.d ./src/push/pn_gateway_access_token_provider.o ./src/push/pn_recipient.d ./src/push/pn_recipient.o ./src/push/pn_recipient_dao.d ./src/push/pn_recipient_dao.o ./src/push/pn_recipients.d ./src/push/pn_recipients.o ./src/push/pn_throttling.d ./src/push/pn_throttling.o ./src/push/push_notification.d ./src/push/push_notification.o
