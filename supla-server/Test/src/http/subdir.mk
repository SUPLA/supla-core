...
clean-src-2f-http:
	-$(RM) ./src/http/abstract_curl_adapter.d ./src/http/abstract_curl_adapter.o ./src/http/asynctask_http_request.d ./src/http/asynctask_http_request.o ./src/http/asynctask_http_thread_bucket.d ./src/http/asynctask_http_thread_bucket.o ./src/http/asynctask_http_thread_pool.d ./src/http/asynctask_http_thread_pool.o ./src/http/curl_adapter.d ./src/http/curl_adapter.o ./src/http/http_event_hub.d ./src/http/http_event_hub.o ./src/http/http_throttling.d ./src/http/http_throttling.o ./src/http/oauth_credentials.d ./src/http/oauth_credentials.o ./src/http/remote_gateway_access_token_provider.d ./src/http/remote_gateway_access_token_provider.o ./src/http/voice_assistant_client.d ./src/http/voice_assistant_client.o
