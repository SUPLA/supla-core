...
clean-src-2f-test-2f-doubles-2f-device:
	-$(RM) ./src/test/doubles/device/DeviceStub.d ./src/test/doubles/device/DeviceStub.o ./src/test/doubles/device/GateValueGetterStub.d ./src/test/doubles/device/GateValueGetterStub.o ./src/test/doubles/device/RegisterDeviceMock.d ./src/test/doubles/device/RegisterDeviceMock.o ./src/test/doubles/device/ValueGetterStub.d ./src/test/doubles/device/ValueGetterStub.o
