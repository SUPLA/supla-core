...
CPP_SRCS += \
../src/test/doubles/vbt/ValueBasedTriggersMock.cpp 

CPP_DEPS += \
./src/test/doubles/vbt/ValueBasedTriggersMock.d 

OBJS += \
./src/test/doubles/vbt/ValueBasedTriggersMock.o 


# Each subdirectory must supply rules for building sources it contributes
src/test/doubles/vbt/%.o: ../src/test/doubles/vbt/%.cpp src/test/doubles/vbt/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-test-2f-doubles-2f-vbt

clean-src-2f-test-2f-doubles-2f-vbt:
	-$(RM) ./src/test/doubles/vbt/ValueBasedTriggersMock.d ./src/test/doubles/vbt/ValueBasedTriggersMock.o

.PHONY: clean-src-2f-test-2f-doubles-2f-vbt
