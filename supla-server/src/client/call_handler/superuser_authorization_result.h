...
#ifndef SUPLA_CH_SUPERUSER_AUTHORIZATION_RESULT_H_
#define SUPLA_CH_SUPERUSER_AUTHORIZATION_RESULT_H_

#include <memory>

#include "client/call_handler/abstract_client_srpc_call_handler.h"

class supla_ch_superuser_authorization_result
 ...
 public:
  ...
  virtual ~supla_ch_superuser_authorization_result();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_SUPERUSER_AUTHORIZATION_RESULT_H_*/
