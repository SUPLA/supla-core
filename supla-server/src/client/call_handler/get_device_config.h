...
#ifndef SUPLA_CLIENT_CH_GET_DEVICE_CONFIG_H_
#define SUPLA_CLIENT_CH_GET_DEVICE_CONFIG_H_

#include <memory>

#include "client/call_handler/abstract_client_srpc_call_handler.h"

class supla_client_ch_get_device_config
 ...
 public:
  supla_client_ch_get_device_config(void);
  virtual ~supla_client_ch_get_device_config();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CLIENT_CH_GET_DEVICE_CONFIG_H_*/
