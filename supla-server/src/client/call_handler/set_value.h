...
#ifndef SUPLA_CH_SET_VALUE_H_
#define SUPLA_CH_SET_VALUE_H_

#include <memory>

#include "client/call_handler/abstract_client_srpc_call_handler.h"

class supla_ch_set_value : public supla_abstract_client_srpc_call_handler {
 protected:
 ...
 public:
  supla_ch_set_value(void);
  virtual ~supla_ch_set_value();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_SET_VALUE_H_*/
