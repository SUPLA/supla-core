...
#ifndef SUPLA_CH_CHANNEL_SET_VALUE_H_
#define SUPLA_CH_CHANNEL_SET_VALUE_H_

#include <memory>

#include "client/call_handler/abstract_client_srpc_call_handler.h"

class supla_ch_channel_set_value
 ...
 public:
  supla_ch_channel_set_value(void);
  virtual ~supla_ch_channel_set_value();
};

#endif /* SUPLA_CH_CHANNEL_SET_VALUE_H_*/
