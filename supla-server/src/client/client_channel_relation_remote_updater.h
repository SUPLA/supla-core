...
#ifndef SUPLA_CLIENT_CHANNEL_RELATION_REMOTE_UPDATER_H_
#define SUPLA_CLIENT_CHANNEL_RELATION_REMOTE_UPDATER_H_

#include "distributedobjects/abstract_dobject_remote_updater.h"

class supla_client_channel_relation_remote_updater
 ...
 public:
  explicit supla_client_channel_relation_remote_updater(
      supla_abstract_srpc_adapter *srpc_adapter);
  virtual ~supla_client_channel_relation_remote_updater();
  bool pre_transaction_verification(supla_dobject *object, bool first);
};

#endif /* SUPLA_CLIENT_CHANNEL_RELATION_REMOTE_UPDATER_H_ */
