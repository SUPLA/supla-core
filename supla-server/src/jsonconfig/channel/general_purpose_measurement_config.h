...
class general_purpose_measurement_config : public general_purpose_base_config {
 ...
 public:
  explicit general_purpose_measurement_config(supla_json_config *root);
  general_purpose_measurement_config(void);
  virtual void merge(supla_json_config *dst);
  void set_config(TChannelConfig_GeneralPurposeMeasurement *config);
  bool get_config(TChannelConfig_GeneralPurposeMeasurement *config);
};

#endif /* GENERAL_PURPOSE_MEASUREMENT_CONFIG_H_ */
