...
#include "abstract_channel_value.h"
...
supla_abstract_channel_value::supla_abstract_channel_value(void)
    : supla_vbt_value() {
  memset(this->raw_value, 0, SUPLA_CHANNELVALUE_SIZE);
}

supla_abstract_channel_value::supla_abstract_channel_value(
...
void supla_abstract_channel_value::get_raw_value(
    char raw_value[SUPLA_CHANNELVALUE_SIZE]) {
  memcpy(raw_value, this->raw_value, SUPLA_CHANNELVALUE_SIZE);
}

void supla_abstract_channel_value::set_raw_value(
    char raw_value[SUPLA_CHANNELVALUE_SIZE]) {
  memcpy(this->raw_value, raw_value, SUPLA_CHANNELVALUE_SIZE);
}

bool supla_abstract_channel_value::is_differ(
    supla_abstract_channel_value *value, bool *significant_change) {
...
void supla_abstract_channel_value::apply_channel_properties(
...
supla_channel_extended_value *supla_abstract_channel_value::convert2extended(
