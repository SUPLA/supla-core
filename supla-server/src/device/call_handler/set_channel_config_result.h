...
#ifndef SUPLA_CH_SET_CHANNEL_CONFIG_RESULT_H_
#define SUPLA_CH_SET_CHANNEL_CONFIG_RESULT_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_set_channel_config_result
 ...
 public:
  supla_ch_set_channel_config_result(void);
  virtual ~supla_ch_set_channel_config_result();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_SET_CHANNEL_CONFIG_RESULT_H_*/
