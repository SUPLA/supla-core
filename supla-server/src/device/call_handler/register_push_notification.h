...
#ifndef SUPLA_CH_REGISTER_PUSH_NOTIFICATION_H_
#define SUPLA_CH_REGISTER_PUSH_NOTIFICATION_H_

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_register_push_notification
 ...
 public:
  supla_ch_register_push_notification(void);
  virtual ~supla_ch_register_push_notification();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_REGISTER_PUSH_NOTIFICATION_H_ */
