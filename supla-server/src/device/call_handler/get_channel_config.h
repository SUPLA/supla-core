...
#ifndef SUPLA_CH_GET_CHANNEL_CONFIG_H_
#define SUPLA_CH_GET_CHANNEL_CONFIG_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_get_channel_config
 ...
 public:
  supla_ch_get_channel_config(void);
  virtual ~supla_ch_get_channel_config();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_GET_CHANNEL_CONFIG_H_*/
