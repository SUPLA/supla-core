...
#ifndef SUPLA_CH_SET_SUBDEVICE_DETAILS_H_
#define SUPLA_CH_SET_SUBDEVICE_DETAILS_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_set_subdevice_details
 ...
 public:
  supla_ch_set_subdevice_details(void);
  virtual ~supla_ch_set_subdevice_details();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_SET_SUBDEVICE_DETAILS_H_ */
