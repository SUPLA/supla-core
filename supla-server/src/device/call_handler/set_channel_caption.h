...
#ifndef SUPLA_CH_SET_CHANNEL_CAPTION_H_
#define SUPLA_CH_SET_CHANNEL_CAPTION_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_set_channel_caption
 ...
 public:
  supla_ch_set_channel_caption(void);
  virtual ~supla_ch_set_channel_caption();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_SET_CHANNEL_CAPTION_H_ */
