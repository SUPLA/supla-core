...
#ifndef SUPLA_CH_REGISTER_DEVICE_F_H_
#define SUPLA_CH_REGISTER_DEVICE_F_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_register_device_f
 ...
 public:
  supla_ch_register_device_f(void);
  virtual ~supla_ch_register_device_f();
  virtual bool is_registration_required(void);
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_REGISTER_DEVICE_F_H_*/
