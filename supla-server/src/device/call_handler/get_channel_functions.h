...
#ifndef SUPLA_CH_GET_CHANNEL_FUNCTIONS_H_
#define SUPLA_CH_GET_CHANNEL_FUNCTIONS_H_

#include <memory>

#include "device/call_handler/abstract_device_srpc_call_handler.h"

class supla_ch_get_channel_functions
 ...
 public:
  supla_ch_get_channel_functions(void);
  virtual ~supla_ch_get_channel_functions();
  virtual bool can_handle_call(unsigned int call_id);
};

#endif /* SUPLA_CH_GET_CHANNEL_FUNCTIONS_H_*/
