...
#ifndef SUPLA_CH_DEVICE_CHANNEL_VALUE_CHANED_C_H_
#define SUPLA_CH_DEVICE_CHANNEL_VALUE_CHANED_C_H_

#include "device/call_handler/abstract_device_channel_value_changed.h"

class supla_ch_device_channel_value_changed_c
    : public supla_ch_abstract_device_channel_value_changed {
 public:
  supla_ch_device_channel_value_changed_c(void);
  virtual ~supla_ch_device_channel_value_changed_c();
...
#endif /* SUPLA_CH_DEVICE_CHANNEL_VALUE_CHANED_C_H_*/
