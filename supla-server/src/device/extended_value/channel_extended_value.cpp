...
supla_channel_extended_value::supla_channel_extended_value(void) { value = {}; }

supla_channel_extended_value::supla_channel_extended_value(
    TSuplaChannelExtendedValue *value) {
  this->value = {};
  if (value) {
    memcpy(&this->value, value, sizeof(TSuplaChannelExtendedValue));
  }
}
...
void supla_channel_extended_value::get_raw_value(
    TSuplaChannelExtendedValue *value) {
  if (value) {
    memcpy(value, &this->value, sizeof(TSuplaChannelExtendedValue));
  }
}
