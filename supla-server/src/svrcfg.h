...
#define SERVER_VERSION "23.11.01"
...
#define CFG_GOOGLE_HOME_SYNCREQUEST_TIMEOUT 27
#define CFG_GOOGLE_HOME_STATEREPORT_TIMEOUT 28

#define CFG_PUSH_THREAD_COUNT_LIMIT 29
#define CFG_PUSH_REQUESTS_PER_THREAD 30
#define CFG_PUSH_THREAD_KEEP_ALIVE_SEC 31
#define CFG_PUSH_KEEP_ALIVE_MAX_THREAD_COUNT 32
#define CFG_PUSH_REQUEST_TIMEOUT 33
#define CFG_PUSH_DELAY_WARNING_TIME 34
#define CFG_PUSH_LONG_REQUEST_TIME 35

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 36
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 37

#define CFG_MQTT_ENABLED 38
#define CFG_MQTT_HOST 39
#define CFG_MQTT_PORT 40
#define CFG_MQTT_USERNAME 41
#define CFG_MQTT_PASSWORD 42
#define CFG_MQTT_PREFIX 43
#define CFG_MQTT_SSL 44
#define CFG_MQTT_CLIENTID 45
#define CFG_MQTT_KEEP_ALIVE_SEC 46
