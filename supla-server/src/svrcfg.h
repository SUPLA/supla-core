...
#define SERVER_VERSION "23.07.01"
...
#define CFG_PUSH_THREAD_COUNT_LIMIT 28
#define CFG_PUSH_REQUESTS_PER_THREAD 29
#define CFG_PUSH_THREAD_KEEP_ALIVE_SEC 30
#define CFG_PUSH_KEEP_ALIVE_MAX_THREAD_COUNT 31
#define CFG_PUSH_REQUEST_TIMEOUT 32
#define CFG_PUSH_DELAY_WARNING_TIME 33
#define CFG_PUSH_LONG_REQUEST_TIME 34

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 35
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 36

#define CFG_MQTT_ENABLED 37
#define CFG_MQTT_HOST 38
#define CFG_MQTT_PORT 39
#define CFG_MQTT_USERNAME 40
#define CFG_MQTT_PASSWORD 41
#define CFG_MQTT_PREFIX 42
#define CFG_MQTT_SSL 43
#define CFG_MQTT_CLIENTID 44
#define CFG_MQTT_KEEP_ALIVE_SEC 45
