...
#define CFG_GOOGLE_HOME_SYNCREQUEST_TIMEOUT 28
#define CFG_GOOGLE_HOME_STATEREPORT_TIMEOUT 29

#define CFG_PUSH_THREAD_COUNT_LIMIT 30
#define CFG_PUSH_REQUESTS_PER_THREAD 31
#define CFG_PUSH_THREAD_KEEP_ALIVE_SEC 32
#define CFG_PUSH_KEEP_ALIVE_MAX_THREAD_COUNT 33
#define CFG_PUSH_REQUEST_TIMEOUT 34
#define CFG_PUSH_DELAY_WARNING_TIME 35
#define CFG_PUSH_LONG_REQUEST_TIME 36

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 37
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 38

#define CFG_MQTT_ENABLED 39
#define CFG_MQTT_HOST 40
#define CFG_MQTT_PORT 41
#define CFG_MQTT_USERNAME 42
#define CFG_MQTT_PASSWORD 43
#define CFG_MQTT_PREFIX 44
#define CFG_MQTT_SSL 45
#define CFG_MQTT_CLIENTID 46
#define CFG_MQTT_KEEP_ALIVE_SEC 47
