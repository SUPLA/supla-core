...
#define CFG_PUSH_FCM_URL 28
#define CFG_PUSH_FCM_KEY_FILE 29

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 30
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 31

#define CFG_MQTT_ENABLED 32
#define CFG_MQTT_HOST 33
#define CFG_MQTT_PORT 34
#define CFG_MQTT_USERNAME 35
#define CFG_MQTT_PASSWORD 36
#define CFG_MQTT_PREFIX 37
#define CFG_MQTT_SSL 38
#define CFG_MQTT_CLIENTID 39
#define CFG_MQTT_KEEP_ALIVE_SEC 40
