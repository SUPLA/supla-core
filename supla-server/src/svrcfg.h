...
#define CFG_ALEXA_RESPONSE_TIMEOUT 23
#define CFG_ALEXA_CHANGEREPORT_TIMEOUT 24

#define CFG_GOOGLE_HOME_SYNCREQUEST_TIMEOUT 25
#define CFG_GOOGLE_HOME_STATEREPORT_TIMEOUT 26

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 27
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 28

#define CFG_MQTT_ENABLED 29
#define CFG_MQTT_HOST 30
#define CFG_MQTT_PORT 31
#define CFG_MQTT_USERNAME 32
#define CFG_MQTT_PASSWORD 33
#define CFG_MQTT_PREFIX 34
#define CFG_MQTT_SSL 35
#define CFG_MQTT_CLIENTID 36
#define CFG_MQTT_KEEP_ALIVE_SEC 37
