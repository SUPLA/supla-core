...
#define CFG_ALEXA_RESPONSE_TIMEOUT 21
#define CFG_ALEXA_CHANGEREPORT_TIMEOUT 22

#define CFG_GOOGLE_HOME_SYNCREQUEST_TIMEOUT 23
#define CFG_GOOGLE_HOME_STATEREPORT_TIMEOUT 24

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 25
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 26

#define CFG_MQTT_ENABLED 27
#define CFG_MQTT_HOST 28
#define CFG_MQTT_PORT 29
#define CFG_MQTT_USERNAME 30
#define CFG_MQTT_PASSWORD 31
#define CFG_MQTT_PREFIX 32
#define CFG_MQTT_SSL 33
#define CFG_MQTT_CLIENTID 34
#define CFG_MQTT_KEEP_ALIVE_SEC 35
