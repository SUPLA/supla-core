...
#define CFG_HTTP_REQUEST_TIMEOUT 18
#define CFG_ALEXA_RESPONSE_TIMEOUT 19
#define CFG_ALEXA_CHANGEREPORT_TIMEOUT 20

#define CFG_GOOGLE_HOME_SYNCREQUEST_TIMEOUT 21
#define CFG_GOOGLE_HOME_STATEREPORT_TIMEOUT 22

#define CFG_LIMIT_CONCURRENT_REGISTRATIONS 23
#define CFG_LIMIT_AUTHKEY_AUTH_CACHE_SIZE 24

#define CFG_MQTT_ENABLED 25
#define CFG_MQTT_HOST 26
#define CFG_MQTT_PORT 27
#define CFG_MQTT_USERNAME 28
#define CFG_MQTT_PASSWORD 29
#define CFG_MQTT_PREFIX 30
#define CFG_MQTT_SSL 31
#define CFG_MQTT_CLIENTID 32
#define CFG_MQTT_KEEP_ALIVE_SEC 33
