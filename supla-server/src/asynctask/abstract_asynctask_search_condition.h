...
#ifndef ABSTRACT_ASYNCTASK_SEARCH_CONDITION_H_
#define ABSTRACT_ASYNCTASK_SEARCH_CONDITION_H_
...
class supla_abstract_asynctask_search_condition {
 ...
 public:
  ...
  virtual bool condition_met(supla_abstract_asynctask *task) = 0;
};

#endif /*ABSTRACT_ASYNCTASK_SEARCH_CONDITION_H_*/
