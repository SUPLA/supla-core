...
public:
	supla_client_channel(int Id, int DeviceId, int LocationID, int Func, const char *Caption);
...
public:
	...
	void update_channel(int Id, int DeviceId, int LocationID, int Func, const char *Caption);
