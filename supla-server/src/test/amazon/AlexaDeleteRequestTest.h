...
#ifndef ALEXA_DELETE_REQUEST_TEST_H_
#define ALEXA_DELETE_REQUEST_TEST_H_
...
class AlexaDeleteRequestTest : public AsyncTaskTest {
 protected:
...
#endif /* ALEXA_DELETE_REQUEST_TEST_H_ */
