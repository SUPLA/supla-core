...
#ifndef STATE_WEBHOOK_TOKEN_REFRESH_TEST_H_
#define STATE_WEBHOOK_TOKEN_REFRESH_TEST_H_
...
class StateWebhookTokenRefreshTest : public AsyncTaskTest {
 protected:
...
#endif /* STATE_WEBHOOK_TOKEN_REFRESH_TEST_H_ */
