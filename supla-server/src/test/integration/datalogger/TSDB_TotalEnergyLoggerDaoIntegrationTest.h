...
#ifndef TSDB_TotalEnergyLoggerDaoTest_H_
#define TSDB_TotalEnergyLoggerDaoTest_H_
...
class TSDB_TotalEnergyLoggerDaoIntegrationTest
 ...
 public:
  ...
  virtual ~TSDB_TotalEnergyLoggerDaoIntegrationTest();
  virtual void SetUp();
...
#endif /* TSDB_TotalEnergyLoggerDaoTest_H_ */
