...
#include "TSDB_VoltageLoggerDaoIntegrationTest.h"
...
void TSDB_VoltageLoggerDaoIntegrationTest::SetUp() {
  TSDB_LoggerDaoIntegrationTest::SetUp();
  dao = new supla_voltage_logger_dao(dba);
}

void TSDB_VoltageLoggerDaoIntegrationTest::TearDown() {
  delete dao;
