...
class SrpcAdapterMock : public supla_abstract_srpc_adapter {
 public:
  ...
  MOCK_METHOD1(sc_async_channel_state_pack_update,
               _supla_int_t(TSC_SuplaChannelStatePack *state_pack));
  ...
  MOCK_METHOD1(sd_async_registerdevice_result_b,
               _supla_int_t(TSD_SuplaRegisterDeviceResult_B *result));
  ...
  MOCK_METHOD1(sd_async_device_calcfg_request,
               _supla_int_t(TSD_DeviceCalCfgRequest *request));
};
