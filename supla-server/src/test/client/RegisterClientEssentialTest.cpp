...
TEST_F(RegisterClientEssentialTest,
       clientExistsAndAccessIdIsNotSet_CorrectPasswordProvided) {
  TCS_SuplaRegisterClient_D register_client_d = {};
...
TEST_F(RegisterClientEssentialTest, clientExistsAndAccessIdIsDisabled) {
  TCS_SuplaRegisterClient_D register_client_d = {};
...
TEST_F(RegisterClientEssentialTest, clientExistsAndAccessIdIsInActive) {
  TCS_SuplaRegisterClient_D register_client_d = {};
...
TEST_F(RegisterClientEssentialTest, gettingClientVariablesFailed) {
  TCS_SuplaRegisterClient_D register_client_d = {};
