...
TEST_F(DeliveryTaskTest, recipientsFromAndroidAndiOsPlatforms) {
  ...
  supla_pn_recipient *r1 = new supla_pn_recipient(
      1, 0, false, "0956469ed2650ed09534e4193ef8028f950", "My Profile 123");
  supla_pn_recipient *r2 =
      new supla_pn_recipient(1, 5, false, "2568548549", "ABCD");
  supla_pn_recipient *r3 =
      new supla_pn_recipient(1, 5, true, "ybuabnuf548549", "ABCD");
  ...
  EXPECT_CALL(
      *deliveryTaskCurlAdapter,
      set_opt_post_fields(
          StrEq("{\"message\":{\"token\":"
                "\"0956469ed2650ed09534e4193ef8028f950\",\"android\":{"
                "\"priority\":\"high\",\"data\":{\"profileName\":\"My Profile "
                "123\"},\"notification\":{\"title\":\"TiTle\",\"body\":"
