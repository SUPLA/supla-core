...
TEST_F(PushNotificationRecipientsTest, counting) {
  ...
  recipients.add(new supla_pn_recipient(1, 0, false, "id1", ""),
  ...
  recipients.add(new supla_pn_recipient(2, 1, false, "id2", ""),
                 platform_push_android);
  ...
  recipients.add(new supla_pn_recipient(3, 2, false, "id1", ""),
                 platform_push_ios);
  ...
  recipients.add(new supla_pn_recipient(3, 0, false, "id1", ""),
                 platform_push_ios);
...
TEST_F(PushNotificationRecipientsTest, addAndGet) {
  recipients.add(new supla_pn_recipient(1, 0, false, "and1", ""),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(2, 0, true, "ios1", ""),
                 platform_push_ios);
  recipients.add(new supla_pn_recipient(3, 5, false, "ios2", ""),
                 platform_push_ios);
...
TEST_F(PushNotificationRecipientsTest, ignoringDuplicates) {
  recipients.add(new supla_pn_recipient(1, 0, false, "t1", ""),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(1, 0, false, "t2", ""),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(1, 0, false, "t1", ""),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(1, 1, false, "t1", ""),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(1, 0, true, "t1", ""),
                 platform_push_ios);
...
TEST_F(PushNotificationRecipientsTest, profileName) {
  supla_pn_recipient r0(1, 0, false, "and1", "");
  EXPECT_EQ(r0.get_profile_name(), "");
  supla_pn_recipient r1(1, 0, false, "and1", "MyProfile");
  EXPECT_EQ(r1.get_profile_name(), "MyProfile");
  supla_pn_recipient r2(1, 0, false, "and1", "XYZ");
