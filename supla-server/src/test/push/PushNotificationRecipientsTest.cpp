...
TEST_F(PushNotificationRecipientsTest, counting) {
  ...
  recipients.add(new supla_pn_recipient(3, 2, false, "id1"), platform_push_ios);
  ...
  recipients.add(new supla_pn_recipient(3, 0, false, "id1"), platform_push_ios);
...
TEST_F(PushNotificationRecipientsTest, addAndGet) {
  recipients.add(new supla_pn_recipient(1, 0, false, "and1"),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(2, 0, true, "ios1"), platform_push_ios);
...
TEST_F(PushNotificationRecipientsTest, ignoringDuplicates) {
  ...
  recipients.add(new supla_pn_recipient(1, 1, false, "t1"),
                 platform_push_android);
  recipients.add(new supla_pn_recipient(1, 0, true, "t1"), platform_push_ios);
