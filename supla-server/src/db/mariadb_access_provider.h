...
class supla_mariadb_access_provider : public supla_abstract_db_access_provider,
                                      private svrdb {
 public:
  supla_mariadb_access_provider(void);
  virtual ~supla_mariadb_access_provider(void);
