...
#ifndef SUPLA_DISTRIBUTED_OBJECT_REMOTE_UPDATE_INDICATOR_H_
#define SUPLA_DISTRIBUTED_OBJECT_REMOTE_UPDATE_INDICATOR_H_

class supla_dobject_remote_update_indicator {
 private:
  bool updated;
