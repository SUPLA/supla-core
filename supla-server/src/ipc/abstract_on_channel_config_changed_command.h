...
#define CONFIG_CHANGE_SCOPE_OTHER 0x1
#define CONFIG_CHANGE_SCOPE_FUNCTION 0x2
#define CONFIG_CHANGE_SCOPE_HVAC 0x4
#define CONFIG_CHANGE_SCOPE_WEEKLY_SCHEDULE 0x8
#define CONFIG_CHANGE_SCOPE_ALT_WEEKLY_SCHEDULE 0x10
