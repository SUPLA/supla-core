...
#ifndef SUPLA_ABSTRACT_BEFORE_DEVICE_DELETE_COMMAND_H_
#define SUPLA_ABSTRACT_BEFORE_DEVICE_DELETE_COMMAND_H_

#include <string>

#include "ipc/abstract_ipc_command.h"

class supla_abstract_before_device_delete_command
