...
#ifndef SUPLA_ALEXA_CRED_CHANGED_COMMAND_H_
#define SUPLA_ALEXA_CRED_CHANGED_COMMAND_H_

#include <string>

#include "ipc/abstract_alexa_cred_changed_command.h"

class supla_alexa_cred_changed_command
...
#endif /* SUPLA_ALEXA_CRED_CHANGED_COMMAND_H_ */
