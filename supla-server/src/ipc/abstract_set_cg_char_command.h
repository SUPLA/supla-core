...
#ifndef SUPLA_ABSTRACT_SET_CG_CHAR_COMMAND_H_
#define SUPLA_ABSTRACT_SET_CG_CHAR_COMMAND_H_
...
class supla_abstract_set_cg_char_command : public supla_abstract_ipc_command {
 ...
 public:
  explicit supla_abstract_set_cg_char_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ABSTRACT_SET_CG_CHAR_COMMAND_H_ */
