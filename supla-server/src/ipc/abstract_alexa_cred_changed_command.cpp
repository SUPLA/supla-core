...
const string supla_abstract_alexa_cred_changed_command::get_command_name(void) {
  return "USER-ALEXA-CREDENTIALS-CHANGED:";
}

void supla_abstract_alexa_cred_changed_command::on_command_match(
    const char *params) {
  int user_id = 0;
