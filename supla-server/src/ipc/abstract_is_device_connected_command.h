...
#ifndef SUPLA_ABSTRACT_IS_DEVICE_CONNECTED_COMMAND_H_
#define SUPLA_ABSTRACT_IS_DEVICE_CONNECTED_COMMAND_H_
...
class supla_abstract_is_device_connected_command
 ...
 public:
  explicit supla_abstract_is_device_connected_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ABSTRACT_IS_DEVICE_CONNECTED_COMMAND_H_ */
