...
#ifndef SUPLA_ABSTRACT_SET_DIGIGLASS_COMMAND_H_
#define SUPLA_ABSTRACT_SET_DIGIGLASS_COMMAND_H_

#include <string>

#include "ipc/abstract_ipc_command.h"

class supla_abstract_set_digiglass_value_command
 ...
 public:
  explicit supla_abstract_set_digiglass_value_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ABSTRACT_SET_DIGIGLASS_COMMAND_H_ */
