...
const string supla_abstract_on_device_deleted_command::get_command_name(void) {
  return "USER-ON-DEVICE-DELETED:";
}

void supla_abstract_on_device_deleted_command::on_command_match(
    const char *params) {
  int user_id = 0;
  int device_id = 0;
