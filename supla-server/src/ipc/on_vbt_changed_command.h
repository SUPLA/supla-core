...
#ifndef SUPLA_ON_VBT_CHANGED_COMMAND_H_
#define SUPLA_ON_VBT_CHANGED_COMMAND_H_
...
class supla_on_vbt_changed_command : public supla_abstract_ipc_command {
 ...
 public:
  explicit supla_on_vbt_changed_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ON_VBT_CHANGED_COMMAND_H_ */
