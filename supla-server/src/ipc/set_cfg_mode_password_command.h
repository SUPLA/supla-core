...
#ifndef SUPLA_SET_CFG_MODE_PASSWORD_COMMAND_H_
#define SUPLA_SET_CFG_MODE_PASSWORD_COMMAND_H_

#include <string>

#include "ipc/abstract_set_cfg_mode_password_command.h"

class supla_set_cfg_mode_password_command
...
#endif /* SUPLA_SET_CFG_MODE_PASSWORD_COMMAND_H_ */
