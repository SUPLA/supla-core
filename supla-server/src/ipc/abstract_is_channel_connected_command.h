...
#ifndef SUPLA_ABSTRACT_IS_CHANNEL_CONNECTED_COMMAND_H_
#define SUPLA_ABSTRACT_IS_CHANNEL_CONNECTED_COMMAND_H_
...
#endif /* SUPLA_ABSTRACT_IS_CHANNEL_CONNECTED_COMMAND_H_ */
