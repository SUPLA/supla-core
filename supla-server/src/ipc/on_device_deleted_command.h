...
#ifndef SUPLA_ON_DEVICE_DELETED_COMMAND_H_
#define SUPLA_ON_DEVICE_DELETED_COMMAND_H_

#include <ipc/abstract_on_device_deleted_command.h>

#include <string>

class supla_on_device_deleted_command
...
#endif /* SUPLA_ON_DEVICE_DELETED_COMMAND_H_ */
