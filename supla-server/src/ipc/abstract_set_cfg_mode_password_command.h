...
#ifndef SUPLA_ABSTRACT_SET_CFG_MODE_PASSWORD_COMMAND_H_
#define SUPLA_ABSTRACT_SET_CFG_MODE_PASSWORD_COMMAND_H_
...
#endif /* SUPLA_ABSTRACT_SET_CFG_MODE_PASSWORD_COMMAND_H_ */
