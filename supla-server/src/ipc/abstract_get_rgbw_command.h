...
#ifndef SUPLA_ABSTRACT_GET_RGBW_COMMAND_H_
#define SUPLA_ABSTRACT_GET_RGBW_COMMAND_H_

#include <string>

#include "ipc/abstract_ipc_command.h"

class supla_abstract_get_rgbw_command : public supla_abstract_ipc_command {
 protected:
...
#endif /* SUPLA_ABSTRACT_GET_RGBW_COMMAND_H_ */
