...
#ifndef SUPLA_ABSTRACT_GET_CONTAINER_VALUE_COMMAND_H_
#define SUPLA_ABSTRACT_GET_CONTAINER_VALUE_COMMAND_H_
...
class supla_abstract_get_container_value_command
 ...
 public:
  explicit supla_abstract_get_container_value_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
  virtual const std::string get_command_name(void);
};

#endif /* SUPLA_ABSTRACT_GET_CONTAINER_VALUE_COMMAND_H_ */
