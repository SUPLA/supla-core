...
#ifndef SUPLA_ABSTRACT_BEFORE_CHANNEL_FUNCTION_CHANGE_COMMAND_H_
#define SUPLA_ABSTRACT_BEFORE_CHANNEL_FUNCTION_CHANGE_COMMAND_H_

#include <string>

#include "ipc/abstract_ipc_command.h"

class supla_abstract_before_channel_function_change_command
