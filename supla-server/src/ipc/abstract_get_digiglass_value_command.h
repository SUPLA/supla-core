...
#ifndef SUPLA_ABSTRACT_GET_DIGIGLASS_VALUE_COMMAND_H_
#define SUPLA_ABSTRACT_GET_DIGIGLASS_VALUE_COMMAND_H_
...
class supla_abstract_get_digiglass_value_command
 ...
 public:
  explicit supla_abstract_get_digiglass_value_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ABSTRACT_GET_DIGIGLASS_VALUE_COMMAND_H_ */
