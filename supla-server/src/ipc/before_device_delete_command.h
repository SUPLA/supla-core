...
#ifndef SUPLA_BEFORE_DEVICE_DELETE_COMMAND_H_
#define SUPLA_BEFORE_DEVICE_DELETE_COMMAND_H_

#include <ipc/abstract_before_device_delete_command.h>

#include <string>

class supla_before_device_delete_command
...
#endif /* SUPLA_BEFORE_DEVICE_DELETE_COMMAND_H_ */
