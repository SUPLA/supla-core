...
#ifndef SUPLA_ABSTRACT_DEVICE_SET_TIME_COMMAND_H_
#define SUPLA_ABSTRACT_DEVICE_SET_TIME_COMMAND_H_
...
class supla_abstract_device_set_time_command
 ...
 protected:
  ...
  virtual bool set_time(supla_user *user, int device_id,
                        ...
                        unsigned char sec, const char *timezone) = 0;

 public:
  explicit supla_abstract_device_set_time_command(
      supla_abstract_ipc_socket_adapter *socket_adapter);
};

#endif /* SUPLA_ABSTRACT_DEVICE_SET_TIME_COMMAND_H_ */
