...
supla_ota_check_updates_command::supla_ota_check_updates_command(
    supla_abstract_ipc_socket_adapter *socket_adapter)
    : supla_abstract_ota_check_updates_command(socket_adapter) {}

bool supla_ota_check_updates_command::check_updates(
  ...
  if (user) {
    ...
    if (device) {
      return device->check_updates(queued_at, waiting_for_result);
    }
  }
