...
#ifndef CURRENT_LOGGER_H_
#define CURRENT_LOGGER_H_

#include <vector>

#include "datalogger/abstract_electricity_logger.h"

class supla_current_logger : public supla_abstract_electricity_logger {
 protected:
 ...
 public:
  supla_current_logger();
  virtual ~supla_current_logger();
};

#endif /* CURRENT_LOGGER_H_ */
