...
supla_voice_assistant_client2::supla_voice_assistant_client2(
...
supla_channel_value *supla_voice_assistant_client2::get_channel_value(void) {
  return channel_value;
}

supla_abstract_curl_adapter *supla_voice_assistant_client2::get_curl_adapter(
    void) {
  return curl_adapter;
}

supla_http_oauth_credentials *supla_voice_assistant_client2::get_credentials(
    void) {
  return credentials;
}

bool supla_voice_assistant_client2::is_channel_connected(void) {
  return channel_connected;
}

string supla_voice_assistant_client2::get_endpoint_id(void) {
  string result;
