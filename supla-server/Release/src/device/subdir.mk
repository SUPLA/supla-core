...
clean-src-2f-device:
	-$(RM) ./src/device/abstract_channel_property_getter.d ./src/device/abstract_channel_property_getter.o ./src/device/abstract_common_channel_properties.d ./src/device/abstract_common_channel_properties.o ./src/device/abstract_device_dao.d ./src/device/abstract_device_dao.o ./src/device/channel_address.d ./src/device/channel_address.o ./src/device/channel_fragment.d ./src/device/channel_fragment.o ./src/device/channel_property_getter.d ./src/device/channel_property_getter.o ./src/device/device.d ./src/device/device.o ./src/device/device_dao.d ./src/device/device_dao.o ./src/device/devicechannel.d ./src/device/devicechannel.o ./src/device/devicechannels.d ./src/device/devicechannels.o
