...
void dbcommon::mainthread_end(void) {
	mysql_library_end();
}

void dbcommon::thread_init(void) {
	mysql_thread_init();
}

void dbcommon::thread_end(void) {
	mysql_thread_end();
}
...
void dbcommon::start_transaction(void) {
	query("START TRANSACTION");
}

void dbcommon::commit(void) {
	query("COMMIT");
}

void dbcommon::rollback(void) {
...
bool dbcommon::stmt_execute(void **_stmt, const char *stmt_str, void *bind, int bind_size, bool exec_errors) {
...
bool dbcommon::stmt_get_int(void **_stmt, int *value1, int *value2, int *value3, int *value4, const char *stmt_str, void *bind, int bind_size, bool exec_errors) {
