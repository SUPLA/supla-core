...
#define SUPLA_FACADEBLIND_TYPE_KEEP_POSITION_DURING_TILTING 1
#define SUPLA_FACADEBLIND_TYPE_CHANGE_POSITION_DURING_TILTING 2
#define SUPLA_FACADEBLINE_TYPE_TILTING_ONLY_AT_FULLY_CLOSED 3
