...
#define EM_VAR_ALL_BASIC 0xFFFF
#define EM_VAR_PHASE1_DISABLED 0x10000  // v. >= 12
#define EM_VAR_PHASE2_DISABLED 0x20000  // v. >= 12
#define EM_VAR_PHASE3_DISABLED 0x40000  // v. >= 12
